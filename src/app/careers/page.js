    ...
    <>
      ...
      <section className="careers-hero">
        <div className="container hero-content">
          ...
          <p className="lede">
            At Mears Law, we believe in investing in the next generation of legal professionals. Our
            firm offers meaningful opportunities for law clerk students and law students to gain
            hands-on experience, develop practical skills, and contribute to impactful legal work across
      ...
      <style jsx>{`
        ...
        .applicant-type strong { color: #0a1628; font-weight: 600; }

        .apply-action { text-align: center; margin-top: 32px; }
        .apply-button {
          display: inline-flex;
          align-items: center;
          gap: 12px;
        ...
        .apply-button svg { transition: transform 0.3s ease; }
        .apply-button:hover svg { transform: translateX(4px); }
        ...
        .apply-note a { color: #3b82f6; text-decoration: none; }
        ...
        @media (max-width: 640px) {
          ...
          .why-join,
          .who-were-looking-for,
          .apply-online { padding-left: 20px; padding-right: 20px; }
          .apply-button { width: 100%; justify-content: center; }
          .applicant-type { flex-direction: column; gap: 12px; }
        }
      `}</style>
    </>
  );
