  ...
  return (
    <main style={{ minHeight: "70vh", padding: "80px 0", background: "#f9fafb" }}>
      <div style={{ width: "min(720px, 92%)", margin: "0 auto" }}>
        ...
        {/* ConvertKit injects the full form here */}
        <div className="formkit-container" data-uid="ea71ad71fe" />

        {/* Important bits: give Script an id and run afterInteractive */}
        <script async data-uid="ea71ad71fe" src="https://mearslaw.kit.com/ea71ad71fe/index.js"></script>
      </div>
    </main>
  );
}
